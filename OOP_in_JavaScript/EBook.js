...
export class EBook extends Book {
  ...
  printInfo() {
    console.log(
      `Full description of the book: Book name: '${this.name}', Book author: ${this.author}, year of publication: ${this.yearOfPublication}, file format ${this.fileFormat}`,
    );
  }
  ...
  static createFromBook(bookInstance, fileFormat) {
    return new EBook(
      bookInstance.name,
      bookInstance.author,
      bookInstance.yearOfPublication,
      fileFormat,
    );
  }
}
